...
class Project:
    ...
    node_classifications: Optional[Dict[str, str]] = None  # node_uuid -> entity_type mapping
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "node_classifications": self.node_classifications,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            node_classifications=data.get('node_classifications'),
